...
frequencyVec = frequencyOffset * timeSteps /sampleRate;
outData = inData.*exp(1i*2*pi*(iniState + frequencyVec(1:inputLength)));
varargout{1} = iniState + frequencyVec(inputLength + 1);
end