...
[txWaveInt,freqOff] = shiftInFrequency(attenAWNWaveform,sampleRate);
...
function [y,freqOff] = shiftInFrequency(waveform, sr)
freqOffset = comm.PhaseFrequencyOffset(...
  'SampleRate',sr);

% Define Bluetooth channels in MHz
bt_channels = [2412, 2417, 2422, 2427, 2432, 2437, 2442, 2447, 2452, 2457, 2462, 2467, 2472];

% Choose random Bluetooth channel
